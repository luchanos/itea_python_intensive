...
#
#
# def some_other_func_b(message):
#     bot.reply_to(message, text="Сообщение из функции some_other_func_b")
#
#
...
#     if message.text[6:] == "a":
#         bot.register_next_step_handler(message, some_other_func)
#     elif message.text[6:] == "b":
#         bot.register_next_step_handler(message, some_other_func_b)
#     bot.reply_to(message, text="Конец выполнения some_func")
